 ...
 */
export function set_transparent_mode(mode: boolean): void;
...
export interface InitOutput {
    ...
    readonly set_transparent_mode: (a: number) => void;
    readonly set_zoom: (a: number) => void;
    readonly get_zoom: () => number;
    readonly wasm_bindgen__closure__destroy__h0961b39a1ced778b: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hd83c1c2416b3630d: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h7d9d5be39643ee4e: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1115b2d2f01508be: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hbba38c098e4f641f: (a: number, b: number) => void;
